...
export default function Configure() {
  ...
  const [isClassroomNumberInvalid, setIsClassroomNumberInvalid] = useState(false); // Track classroom number validation state
  ...
  const validateTimeframe = (value: string) => {
    ...
    const matchesRegex = value.match(/^((?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec|January|February|March|April|May|June|July|August|September|October|November|December)+)(-| )((?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec|January|February|March|April|May|June|July|August|September|October|November|December)+)$/); // Your existing regex
  ...
  const handleSave = () => {
    ...
    const isClassroomNumberEmpty = !classroomNumber || classroomNumber.trim() === '';

    setIsTimeframeInvalid(isTimeframeEmpty || !validateTimeframe(timeframeValue));
    setIsClassroomNumberInvalid(isClassroomNumberEmpty || !validateClassroomNumber(classroomNumber));

    if (!isTimeframeEmpty && !isClassroomNumberEmpty && !isTimeframeInvalid && !isClassroomNumberInvalid) {
        ...
        router.push(`/manage/configure/details?timeframe=${timeframeValue}&classroomNumber=${classroomNumber}`);
    }
};
      ...
      <Card className="w-1/2">
        <CardBody className="p-5 flex flex-col">
          ...
          <Input
            ...
            variant="bordered"
            errorMessage={isTimeframeInvalid && "Please enter a valid timeframe"}
          ...
          <Input
            ...
            errorMessage={isClassroomNumberInvalid && "Please enter a number (0-29)"}
